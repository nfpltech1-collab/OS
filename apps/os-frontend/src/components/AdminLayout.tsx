        ...
        <nav className="flex flex-col gap-0.5 p-3 flex-1 overflow-y-auto">
          ...
          {isAdmin && (
            <>
              ...
              <NavItem icon={<IconUsers />}     label="Users"        href="/dashboard/admin"             active={pathname === '/dashboard/admin' || (pathname.startsWith('/dashboard/admin/') && !pathname.startsWith('/dashboard/admin/apps') && !pathname.startsWith('/dashboard/admin/departments') && !pathname.startsWith('/dashboard/admin/audit-logs'))} />
              <NavItem icon={<IconLogs />}      label="Audit Logs"   href="/dashboard/admin/audit-logs"  active={pathname.startsWith('/dashboard/admin/audit-logs')} />
            </>
          )}
